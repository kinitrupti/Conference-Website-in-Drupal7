  ...
  <div id="header-wrap" class="clr fixed-header">
    <header id="header" class="site-header clr">
      <div id="logo" class="clr">
        ...
        <h1 align="right"><a href="Contact" > <font color="000066" size="2">Contact Us</a></font></font></h1>
...
<li>
          <img src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/slide-image-4.jpg'; ?>">
        </li>
<li>
          <img src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/slide-image-5.jpg'; ?>">
        </li>
<li>
          <img src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/slide-image-6.jpg'; ?>">
        </li>
<li>
          <img src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/slide-image-7.jpg'; ?>">
        </li>
      </ul>
    </div>
  </div>
